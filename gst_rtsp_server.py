...
class MyFactory(GstRtspServer.RTSPMediaFactory):
	...
	def do_create_element(self, url):
		#s_src = "v4l2src device = /dev/video0 ! video/x-raw,rate=30,width=320,height=240 ! videoconvert ! video/x-raw,format=I420"
		...
		pipeline_str = "(v4l2src device=/dev/video2 ! videoconvert ! queue ! x264enc tune=zerolatency ! video/x-h264,alignment=au,stream-format=byte-stream,profile=main ! h264parse ! mpegtsmux name=muxer ! tsparse ! rtpmp2tpay name=pay0 pt=96 )"
